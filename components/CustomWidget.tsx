        ...
        <>
            ...
            >
                            ...
                            render={({field: {onChange, value}}) => {
                                return (
                                    <FormInput title="" error={errors.color?.type}>
                                        ...
                                        >
                                            <PreviewWrapper style={{height: '98px', width: '98px'}}>{file ?
                                                <PreviewFile file={file} setAvatar={setAvatarToConfig}/> :
                                                <Icon icon={'material-symbols:cloud-upload'} color={'#65a2fa'}
                                                      fontSize={60}/>}</PreviewWrapper>
                                        </Uploader3>
                                    </FormInput>
                                );
                            }}
                                        ...
                                        <InputBase
                                            ...
                                            startAdornment={
                                                <InputAdornment position="start">
                                                    <Image src="/icons/twitter-new.svg" alt="twitter" width="24"
                                                           height="24"/>
                                                </InputAdornment>
                                            }
                                            onChange={(e: any) => {
                                ...
                                return (
                                    <FormInput title="" error={errors.telegram?.type}>
                                        <InputBase
                                            ...
                                            startAdornment={
                                                <InputAdornment position="start">
                                                    <Image src="/icons/telegram-new.svg" alt="telegram" width="24"
                                                           height="24"/>
                                                </InputAdornment>
                                            }
                                            value={value}
                                    ...
                                    <FormInput title="Account" error={errors.accountType?.type}>
                                        ...
                                        >
                                                ...
                                                label={
                                                    <Box height={30}>
                                                        <Typography variant="body1"
                                                                    sx={{mt: {sm: '-30px', xs: '-30px', md: '0px'}}}
                                                                    lineHeight="28px" fontWeight={600} color="#0F172A"
                                                                    mb={1}>
                                                            EOA
                                                        </Typography>
                                                        <Typography variant="body2" sx={{lineHeight: "26px"}}
                                                                    color="#64748B">
                                            ...
                                            <FormControlLabel
                                                ...
                                                label={
                                                    <Box height={30}>
                                                        <Typography variant="body1" sx={{mt: {xs: '-30px', md: '0px'}}}
                                                                    lineHeight="28px" fontWeight={600} color="#0F172A"
                                                                    mb={1}>
                                                            Safe Account
                                                        </Typography>
                                            ...
                                            >
                                                {networks.map((item: { id: number; network: string; icon: any }) => (
                                                    <MenuItem value={item.id} key={item.id}>
                                                        <SvgIcon sx={{borderRadius: '50%', mr: 1.25}}
                                                                 component={item.icon}/>
                                                        {item.network}
                                                    </MenuItem>
                                                ))}
                                                ...
                                                endAdornment={
                                                    <InputAdornment sx={{
                                                        ...
                                                        <SvgIcon sx={{cursor: 'pointer'}}
                                                                 onClick={() => handleDelete(index)} component={Delete}
                                                                 inheritViewBox/>
                                                    </InputAdornment>
                                                }
                                                value={item.address}
              ...
              */}
                            ...
                            <Accordion expanded={expanded === 'panel1'} onChange={
                                ...
                                <AccordionDetails>
                                    <Typography variant='h3' sx={{
                                        ...
                                        width: '100%',
                                        flexShrink: 0
                                    }}>Donation amount settings </Typography>
                                        ...
                                        <Box sx={{display:'flex'}}>
                                            <Box>
                                                ...
                                                render={({}) => {
                                                    return (
                                                        <FormInput
                                                            title="Start time" /*error={errors.name?.type}*/
                                                        >
                                            ...
                                            <Box sx={{marginLeft:{md:'40px'}}}>
                                                ...
                                                render={({}) => {
                                                    return (
                                                        <FormInput
                                                            title="End time" /*error={errors.name?.type}*/
                                                        >
                                                            <LocalizationProvider dateAdapter={AdapterDayjs}>
                                                                <DatePicker
                                                                    label="Select"
                    ...
                    >
                        <Donate3Btn loadingButton loading={loading} onClick={handleClickConfirmBtn} variant="contained"
